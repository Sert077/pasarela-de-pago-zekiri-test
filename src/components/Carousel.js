  ...
  return (
    <section className="bg-gray-100 py-10">
      <div className="container mx-auto text-center">
        ...
        <p className="text-lg mb-8 text-black">Acepta pagos en línea con todas las tarjetas de crédito y débito respaldadas por Visa, Mastercard y American Express.</p>
